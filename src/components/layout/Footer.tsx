    ...
    <footer className="bg-gray-900 text-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            <Link to="/" className="text-2xl font-serif font-bold">
              Avant<span className="text-amber-400">Elite</span>
            </Link>
            <p className="mt-4 text-gray-400 max-w-xs">
              Exclusive luxury properties for discerning clients worldwide. Excellence, exclusivity, and exceptional service.
            </p>
          ...
          <div className="col-span-1">
            ...
            <address className="not-italic text-gray-400">
              ...
              <p className="mb-2">info@avantelite.com</p>
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 mb-4">Subscribe to get exclusive updates on new properties</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} AvantElite Luxury Properties. All rights reserved.</p>
